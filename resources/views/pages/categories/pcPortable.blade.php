  ...
  <div class="container">
    ...
    <div class="card">
      <div class="image-container">
        <a href="#" onclick="refreshPageAndGo('{{ route('detailsP', ['id' => $pcportable->id]) }}');">
          <img src="{{ asset($pcportable->img) }}" alt="Product Image">
        </a>
      </div>
      <h2 class="title">{{ $pcportable->title }}</h2>
      <div class="price-container">
        <span class="price">{{ $pcportable->prix }} DH</span>
        @php
        $lastPrice = $pcportable->prix * 1.15;
        @endphp
